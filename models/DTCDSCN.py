...
class CDNet_model(nn.Module):
    def __init__(self, in_channels=3, block=SEBasicBlock, layers=[3, 4, 6, 3], num_classes=2):
        ...
        ################################## my my begin 
        self.regressor =  nn.Conv2d(32, 1, 3, padding=1)
    ...
    def forward(self, x, y):
        ...
        ################################## my my begin 
        out2d = self.finalconv3_master(out)

        out3d = self.regressor(out)
        out3d = self.active3d(out3d)
        return out2d, out3d
        ################################## my my end
...
def CDNet34(in_channels, **kwargs):
    ...
    # out2d, out3d = CDNet_model(in_channels, SEBasicBlock, [3, 4, 6, 3], **kwargs)
    # return out2d, out3d